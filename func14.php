...
<body style="background: url('sky.jpg') no-repeat; background-size:cover;">
   ...
   <form class="form-group" name="confirmTicket" action="func18.php" method="post">
      ...
      <input type="text" name="seatCode1" id="seatCode1" class="form-control" readonly value=<?php echo $_GET['seatCode1'];?> ><br/>
      <input type="text" name="flightNo1" id="flightNo1" class="form-control" readonly value=<?php echo $_GET['flightNo1'];?> ><br/>
      <input type="text" name="date1" id="date1" class="form-control" readonly value=<?php echo $_GET['date1'];?> ><br/>
      <input type="text" name="day1" id="day1" class="form-control" readonly value=<?php echo $_GET['day1'];?> ><br/>
      <input type="text" name="time1" id="time1" class="form-control" readonly value=<?php echo $_GET['time1'];?> ><br/>
      <input type="text" name="grossFare1" id="grossFare1" class="form-control" readonly value=<?php echo $_GET['grossFare1'];?> ><br/>
      <input type="text" name="seatCode2" id="seatCode2" class="form-control" readonly value=<?php echo $_GET['seatCode2'];?> ><br/>
      <input type="text" name="flightNo2" id="flightNo2" class="form-control" readonly value=<?php echo $_GET['flightNo2'];?> ><br/>
      <input type="text" name="date2" id="date2" class="form-control" readonly value=<?php echo $_GET['date2'];?> ><br/>
      <input type="text" name="day2" id="day2" class="form-control" readonly value=<?php echo $_GET['day2'];?> ><br/>
      <input type="text" name="time2" id="time2" class="form-control" readonly value=<?php echo $_GET['time2'];?> ><br/>
      <input type="text" name="grossFare2" id="grossFare2" class="form-control" readonly value=<?php echo $_GET['grossFare2'];?> ><br/>
